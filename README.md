# Evosint v2.17 — "Ghost" Monochrome Console (fictional agency theme)
...
| Kitty | **Clicker arcade: 1,000 taps on the 🐈‍⬛ = +20 scans** (server-counted, batched, 10 awards/day, clicks are free — infinite plans stack glory milestones instead) |
